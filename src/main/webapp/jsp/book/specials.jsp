			...
			<div class="left_content">
				<div class="title">
					<span class="title_icon"><img
						src="${base }/images/bullet1.gif" alt="" title="" /></span>${cateName }
				</div>
				<div class="feat_prod_box">

					<c:forEach items="${pageing.books }" var="book" varStatus="status">
						<div class="prod_img">
							<a href="${base }/book/${book.bookId}/detailBook.do"><img src="${base }/images/prod1.gif"
								alt="" title="" border="0" /></a>
						</div>

						<div class="prod_det_box">
							<span class="special_icon"><img
								src="${base }/images/special_icon.gif" alt="" title="" /></span>
							...
							<div class="box_center">
								...
								<p class="details">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：${book.price
									}元</p>
				...
				<div class="pagination">
						<c:if test="${pageing.pageNow!=1 }">
							<a href="${base }/book/1000000/1/${pageing.pageSize}/viewBookByCate.do">首页</a>&nbsp;
							<a href="${base }/book/1000000/${pageing.pageNow-1 }/${pageing.pageSize}/viewBookByCate.do">&lt;&lt;</a>&nbsp;
						</c:if>
						<c:choose>
						...
						<c:forEach var="p" begin="${beg }" end="${beg+2 }">
							<c:if test="${p<=pageing.pageCount }">
								<a href="/book/1000000/${p}/${pageing.pageSize}/viewBookByCate">${p }</a>
							</c:if>
						</c:forEach>
						<c:if test="${pageing.pageNow!=pageing.pageCount }">
							<a href="/book/1000000/${pageing.pageNow+1}/${pageing.pageSize}/viewBookByCate.do">&gt;&gt;</a>&nbsp;
							<a href="/book/1000000/${pageing.pageCount}/${pageing.pageSize}/viewBookByCate.do">末页</a>&nbsp;
						</c:if>
