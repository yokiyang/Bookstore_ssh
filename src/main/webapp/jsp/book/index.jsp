			...
			<div class="left_content">
				...
				<div>
					<div class="feat_prod_box">
						...
						<c:forEach items="${bestBook.books }" var="bestbook" varStatus="status">
						<div class="prod_img">
							<a href="${base }/book/${bestbook.bookId}/detailBook.do"><img src="${base }/images/prod${status.count }.gif" alt=""
								title="" border="0" /></a>
						</div>
						...
						<div class="prod_det_box">
							...
							<div class="box_center">
								<div class="prod_title">图书名称:&nbsp;&nbsp;${bestbook.bookName }</div>
								<p class="details">作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;者：${bestbook.author }</p>
								<p class="details">出&nbsp;&nbsp;版&nbsp;&nbsp;社：${bestbook.publish }</p>
								<p class="details">出版日期：${bestbook.publishDate }</p>
								<p class="details">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：${bestbook.price }元</p>
								<a href="${base }/book/${bestbook.bookId}/detailBook.do" class="more">- 更多信息 -</a>
								<div class="clear"></div>
				...
				<div class="title">
					<span class="title_icon"><img src="${base }/images/bullet2.gif"
						alt="" title="" /></span>新书
				</div>

				<div class="new_products">
					<c:forEach items="${newBook.books }" var="newbook" varStatus="status">
					<div class="new_prod_box">
						<a href="${base }/book/${newbook.bookId}/detailBook.do">${newbook.bookName }</a>
						<div class="new_prod_bg">
							<span class="new_icon"><img src="${base }/images/new_icon.gif"
								alt="" title="" /></span> <a href="${base }/book/${newbook.bookId}/detailBook.do"><img
